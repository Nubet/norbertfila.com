...
const technologies = [
  ...
  },
  {
    name: 'Vite',
    svg: (
      <img src={`${import.meta.env.BASE_URL}vite.svg`} alt="Vite" loading="lazy" />
    )
  }
];
