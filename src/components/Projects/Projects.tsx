...
const projects = [
    ...
    {
        title: 'MicMute',
        description: 'A simple desktop app for Windows and Linux that helps you control your microphone during meetings, streams, or work. It lets you mute and unmute quickly with one click or a global keyboard shortcut.',
    ...
    return (
        <section className="section" id="projects">
                                ...
                                <div className={styles.links}>
                                    ...
                                    {project.downloadLink !== null ? (
                                        project.downloadLink ? (
                                            ...
                                            <span className={`${styles.link} ${styles.getItLink}`}
            ...
            {!all ? (
                ...
                <div className={styles.viewAll}>
                    <a href="https://github.com/nubet?tab=repositories" target="_blank" rel="noopener noreferrer"
