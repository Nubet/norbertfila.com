...
export const caseStudies: CaseStudyData[] = [
  {
    ...
    nextProjectSlug: 'joy-english',
    nextProjectName: 'JOY English School',
  },
  {
    id: 'joy-english',
    title: 'JOY English School',
    clientDescription:
      'JOY English School to dynamicznie rozwijająca się placówka edukacyjna w Koszalinie, wyróżniona prestiżowym tytułem w plebiscycie "Orły". Szkoła słynie z domowej, radosnej atmosfery – na zajęciach widać zaangażowane, uśmiechnięte dzieci, co w 100% oddaje ideę nazwy "JOY". Choć marka zbudowała lojalną społeczność i silną pozycję na mapach Google, brak dedykowanej strony internetowej powodował utratę cennego ruchu organicznego. Rodzice szukający w Google haseł takich jak "angielski dla dzieci Koszalin" często trafiali bezpośrednio do konkurencji. Głównym celem projektu było stworzenie profesjonalnej przestrzeni online, która skutecznie rozwiąże ten problem i zaprezentuje unikalny charakter szkoły.',
    role: 'UX/UI Design & Web Development',
    industry: 'Edukacja',
    year: '2026',
    openingImage: {
      src: '/portfolio/joy-school-szkola-jezykowa/nowoczesna-strona-szkoly-jezykowej-joy.webp',
      width: 4000,
      height: 3000,
    },
    overviewText:
      'Głównym założeniem było stworzenie interfejsu, który nie tylko generuje zapisy, ale jest cyfrowym odbiciem przyjaznej, bezstresowej metodyki szkoły. Aby to osiągnąć, oparłem design na identyfikacji wizualnej marki – te same pogodne kolory, które można znaleźć w przytulnych wnętrzach placówki oraz na profilach w mediach społecznościowych, stały się fundamentem nowoczesnej witryny.\n\nPod kątem UX (User Experience) zaprojektowałem czytelną architekturę informacji. Od początku postawiłem na przejrzyste moduły, które zgrabnie kategoryzują ofertę na kursy grupowe, zajęcia indywidualne oraz letnie półkolonie. Jako główne Call-to-Action (CTA) wykorzystałem płynne przekierowanie do istniejącego już formularza Google, z którego placówka korzystała na co dzień. Dzięki takiemu rozwiązaniu, zespół szkoły nie musiał wdrażać się w żadne nowe systemy ani zmieniać swoich nawyków, a jednocześnie był gotowy na obsługę rosnącej liczby zapytań płynących ze strony. Jako alternatywę mocno wyeksponowałem bezpośredni kontakt telefoniczny – kluczowy zwłaszcza przy zapytanich lub rejestracjach na półkolonie.\n\nAby maksymalnie wzmocnić zaufanie rodziców, strona pokazuje najnowsze, pięciogwiazdkowe opinie rodziców oraz interaktywną mapę dojazdu. Gotowy projekt to estetyczne i w pełni funkcjonalne narzędzie, które natychmiastowo przekazuje najwyższą jakość edukacji, buduje wiarygodność w oczach rodziców i jest przygotowane do efektywnego pozyskiwania nowych kursantów z wyników wyszukiwania.',
    galleryImage1: {
      src: '/portfolio/joy-school-szkola-jezykowa/przyjazna-atmosfera-szkola-jezykowa.webp',
      width: 6000,
      height: 4500,
    },
    galleryImage2: {
      src: '/portfolio/joy-school-szkola-jezykowa/cennik-kursow-jezykowych-oferta.webp',
      width: 6000,
      height: 4500,
    },
    fullPageMockup: {
      src: '/portfolio/joy-school-szkola-jezykowa/strona-www-szkola-jezykowa-pelny-projekt.webp',
      width: 2560,
      height: 7872,
    },
    prevProjectSlug: 'db-club',
    prevProjectName: 'Butikowe Studio Ruchu',
    nextProjectSlug: 'filips-school',
    nextProjectName: "Filip's School",
  },
  {
    id: 'filips-school',
    title: "Filip's School",
    clientDescription:
      'Filip\'s School to renomowana szkoła językowa w Łomży z 20-letnią tradycją i imponującą listą sukcesów, wielokrotnie wyróżniana tytułem "Złotych Orłów Edukacji" oraz posiadająca status akredytowanego centrum Cambridge. Mimo ugruntowanej pozycji i ogromnego zaufania uczniów, wyzwaniem było skuteczne dotarcie z ofertą do nowych odbiorców w świecie cyfrowym. Celem projektu było stworzenie nowoczesnego landing page\'a, który w wizualnie atrakcyjny sposób ukaże to, co placówka ma najlepszego: sprawdzoną metodykę, wyjazdy do Londynu oraz osiągnięcia swoich laureatów.',
    role: 'Logo & Web Design',
    industry: 'Edukacja',
    year: '2026',
    openingImage: {
      src: '/portfolio/filips-school/nowoczesny-landing-page-nauka-angielskiego.webp',
      width: 2560,
      height: 1287,
    },
    overviewText:
      'Od samego początku zależało mi na zbudowaniu interfejsu, który w umiejętny sposób połączy wieloletnią tradycję z nowoczesnym podejściem do edukacji. Proces ten rozpocząłem od zaprojektowania od podstaw nowego logo, które stało się fundamentem identyfikacji wizualnej. Paletę barw oparłem na kolorach bezpośrednio kojarzących się z Wielką Brytanią i brytyjską flagą – głębokim granacie (Navy) oraz wyrazistej czerwieni, przełamywanych czystą bielą i piaskowym beżem. Całość dopełniłem fontem Playfair używanym w nagłówkach, który w połączeniu z prostym fontem Inter, kreuje schludny i wysoce profesjonalny wizerunek.\n\nPod kątem User Experience (UX), główny nacisk położyłem na wyeksponowanie elementów budujących zaufanie odwiedzającego stronę – od doskonałej średniej ocen 4.9/5, po imponującą listę laureatów i finalistów konkursów. Zamiast budować standardowe bloki tekstu, zaprojektowałem dedykowane sekcje graficzne opowiadające o praktycznej nauce języka podczas edukacyjnych wyjazdów do Londynu. Te atuty stały się główną osią narracji witryny.\n\nZ uwagi na preferencje rodziców, główne Call-to-Action (CTA) oparto na najchętniej wybieranych kanałach komunikacji: szybkim kontakcie telefonicznym oraz przekierowaniu na profil Facebook, który stanowi ich główne miejsce w sieci. Gotowy projekt to estetyczne i bezkompromisowe narzędzie wizerunkowe, idealnie skrojone by skutecznie przyciągać nowe roczniki kursantów.',
    galleryImage1: {
      src: '/portfolio/filips-school/wyjazdy-jezykowe-londyn-szkola-angielskiego.webp',
      width: 1872,
      height: 1260,
    },
    galleryImage2: {
      src: '/portfolio/filips-school/zapisy-na-angielski-formularz-kontaktowy.webp',
      width: 1872,
      height: 1260,
    },
    fullPageMockup: {
      src: '/portfolio/filips-school/strona-internetowa-szkola-jezykowa-pelny-projekt.webp',
      width: 2560,
      height: 8000,
    },
  ...
  },
  {
    ...
    prevProjectSlug: 'filips-school',
    prevProjectName: "Filip's School",
