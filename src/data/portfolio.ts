...
export const portfolioProjects: PortfolioProject[] = [
  ...
  },
  {
    ...
    description: 'Tworząc stronę dla JOY English School, zależało mi na oddaniu przytulnego i bezstresowego charakteru placówki. Wyeksponowałem zdjęcia kolorowych, przytulnych wnętrz, by budować zaufanie rodziców. Strona wyraźnie promuje nie tylko zajęcia indywidualne, ale również wakacyjne półkolonie',
  ...
  },
  {
    ...
    description: 'Branża finansowa i podatkowa opiera się na zaufaniu i rzetelności. Celem projektu było stworzenie profesjonalnej wizytówki internetowej dla niezależnego doradcy, która od pierwszych sekund buduje wizerunek eksperta. Zrezygnowaliśmy ze skomplikowanego, żargonowego języka na rzecz jasnej i przejrzystej oferty. Minimalistyczny design, połączony z intuicyjną nawigacją oraz przemyślanym formularzem kontaktowym, drastycznie ułatwia potencjalnym klientom podjęcie decyzji o współpracy.',
  ...
  },
  {
    ...
    description: 'Mobilna aplikacja do nauki do ISTQB CTFL z materiałem podzielonym na rozdziały, symulacją egzaminu, wyszukiwaniem w słowniczku i lokalnym śledzeniem postępu. Przejrzysty interfejs, czytelna nawigacja i dopracowane detale – tryb nauki, symulacja i system fiszek w jednym, spójnym doświadczeniu.',
  ...
  },
  {
    ...
    description: 'Narzędzie, które robi dokładnie to, czego potrzebujesz. Skaner i generator kodów QR w minimalistycznym, nowoczesnym wydaniu. Błyskawiczna detekcja linków na żywo, czytelna historia i udostępnianie jednym kliknięciem – zero zbędnych komplikacji.',
