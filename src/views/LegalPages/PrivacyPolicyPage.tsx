      ...
      <div className={styles.container}>
        ...
        <ScrollReveal>
          <article className={styles.content}>
            ...
            <section>
              <p>
                Niniejsza Polityka Prywatności określa zasady dotyczące gromadzenia, wykorzystywania
                i ujawniania danych osobowych, które gromadzę podczas korzystania z mojej strony
            ...
            <section>
              ...
              <ul>
                <li>
                  ...
                  umowy o dzieło/zlecenie (art. 6 ust. 1 lit. b) oraz mój prawnie uzasadniony
                  interes, jakim jest komunikacja z osobami odwiedzającymi Stronę (art. 6 ust. 1
                  lit. f).
                </li>
                <li>
                  <strong>Zbierania opinii klientów:</strong> Podstawą prawną przetwarzania jest mój
                  prawnie uzasadniony interes polegający na doskonaleniu jakości usług i
                  prezentowaniu referencji.
                </li>
                <li>
            ...
            <section>
              ...
              <p>
                Twoje dane osobowe będą przechowywane przez okres niezbędny do obsługi
                korespondencji i udzielenia odpowiedzi na przesłane zapytanie, a po zakończeniu
                kontaktu – przez czas wymagany do zabezpieczenia ewentualnych roszczeń lub do
                momentu zgłoszenia przez Ciebie sprzeciwu wobec ich dalszego przechowywania.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                wymaganych danych osobowych lub wycofasz zgodę na przetwarzanie ich w wymaganych
                celach, możesz nie mieć dostępu do usług, w związku z którymi Twoje dane zostały
                pozyskane, ani możliwości korzystania z nich.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                bezpieczeństwa, aby zapobiec utracie, niewłaściwemu wykorzystaniu lub
                nieautoryzowanej modyfikacji Twoich danych pozostających pod moją kontrolą. Jednak
                ze względu na nieodłączne ryzyko nie mogę zagwarantować całkowitego bezpieczeństwa,
                a co za tym idzie, nie mogę zapewnić ani zagwarantować bezpieczeństwa jakichkolwiek
                informacji, które mi przekazujesz, a robisz to na własne ryzyko.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                obsługiwane. Niniejsza Polityka Prywatności nie dotyczy polityk prywatności ani
                innych praktyk podmiotów trzecich, w tym stron internetowych i usług, do których
                możesz przejść przez link dostępny w Serwisie.
              </p>
              <p>
            ...
            <section>
              ...
              <p>
                Strona może wykorzystywać pliki cookie w celach statystycznych oraz w celu
                zapewnienia prawidłowego działania jej funkcji technicznych. Szczegółowe informacje
                na temat zarządzania plikami cookie znajdziesz w ustawieniach swojej przeglądarki
                internetowej.
              </p>
              <p>
